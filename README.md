...
## Results
We can see that the output coordinates px, py, vx, vy have a RMSE of [0.0974, 0.0855, 0.4517, 0.4404] smaller to the required RMSE of [0.11, 0.11, 0.52, 0.52] for Dataset 1. 

<br/>

[image1]: ./results.png "Dataset Visualization"
![alt text][image1]